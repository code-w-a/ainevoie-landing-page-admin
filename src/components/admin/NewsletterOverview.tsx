...
import { AdminLogStackSkeleton, AdminStatCardsSkeleton, AdminTableSkeleton } from "@/components/admin/AdminSkeletonLayouts";
...
import { adminCommonLabels, campaignStatusLabel, logLevelLabel } from "@/lib/adminLabels";
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Monitorizare pentru abonați, campanii și evenimente de livrare.
          </p>
        </div>
        <Button asChild>
