                ...
                >
                  ...
                  <div className="-mx-[10px] flex flex-wrap items-center justify-center lg:justify-start">
                    <div className="inline-block px-[10px]">
                      <Link
                        href="#"
                        className="bg-primary hover:bg-primary/90 mb-5 inline-flex items-center rounded-md py-[10px] pr-5 pl-4 text-white"
                      >
                    ...
                    <div className="inline-block px-[10px]">
                      <Link
                        href="#"
                        className="mb-5 inline-flex items-center rounded-md bg-black py-[10px] pr-5 pl-4 text-white hover:bg-black/90 dark:bg-white dark:text-black dark:hover:bg-white/90"
                      >
                        <span className="mr-[10px]">
                          <svg
                            width="34"
