    ...
    >
      <div className="relative flex">
        <input
          ...
          placeholder="Caută…"
          className="h-[74px] w-full rounded-lg bg-white pr-5 pl-15 text-black outline-hidden dark:bg-black dark:text-white"
          autoFocus
        />
        ...
        <svg
          ...
          className="pointer-events-none absolute top-0 left-5 h-full text-black dark:text-white"
        >
          <path
