            ...
            <div className="-mx-4 flex flex-wrap items-center justify-between">
              <div className="w-full px-4 lg:w-1/2">
                ...
                >
                  ...
                  <div className="bg-gradient-1 absolute bottom-0 left-0 -z-10 h-1/2 w-full rounded-[20px]">
                    ...
                    <div className="bg-texture absolute top-0 left-0 h-full w-full"></div>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full px-4 lg:w-1/2">
                ...
                >
                  ...
                  <div className="mb-[30px] flex items-center">
                    <div className="border-stroke dark:border-stroke-dark dark:bg-dark mr-[22px] flex h-[60px] w-[60px] items-center justify-center rounded-full border text-xl font-semibold text-black dark:text-white">
                      01
                    </div>
                    <div>
            ...
            <div className="-mx-4 flex flex-wrap items-center justify-between">
              ...
              <div className="order-first w-full px-4 lg:order-last lg:w-1/2">
                ...
                >
                  ...
                  <div className="bg-gradient-2 absolute bottom-0 left-0 -z-10 h-1/2 w-full rounded-[20px]">
                    <div className="absolute -top-12 left-10 -z-10">
                      <svg
                        width="65"
                        height="36"
