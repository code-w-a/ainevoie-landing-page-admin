...
// const VideoModal = dynamic(() => import("./HeroVideo"), {
//   ssr: false
// });
...
const HeroArea = () => {
  ...
  useEffect(() => {
    function handleEscape(e: KeyboardEvent) {
      if (e.key === "Escape" && showNewsletterDialog) {
  ...
  return (
    <>
            ...
            <div className="w-full px-4 lg:w-7/12">
              ...
              >
                ...
                <div className="flex flex-wrap items-center">
                  ...
                  {/*
                    Temporar ascuns: repune când avem video real (link + VideoModal + state toggler + dynamic import).
                    <Link
                      href="#"
                    ...
                    >
                      ...
                      <span className="text-base font-medium">
                        <span className="block text-sm"> Vezi cum funcționează (1 min) </span>
                        {" "}
                      </span>
                    </Link>

                    <VideoModal toggler={toggler} />
                  */}
                </div>
              </div>
            </div>
      ...
      {showNewsletterDialog && (
        ...
        >
          <div
            className="relative w-full max-w-[500px] rounded-lg bg-white p-8 shadow-xl dark:bg-dark"
